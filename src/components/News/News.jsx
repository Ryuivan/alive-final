...
export default function News() {
  return (
    <div className="news-bg">
      <img src="https://cdn.discordapp.com/attachments/1139426470901600336/1162958206755164192/left.webp" alt="left-ornament" className="left-news" />
      <img src="https://cdn.discordapp.com/attachments/1139426470901600336/1162958207002611752/right.webp" alt="right-ornament" className="right-news" />
