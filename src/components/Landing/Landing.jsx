...
export default function Landing() {
  ...
  const startTimer = () => {
    const countdownDate = new Date("November 15, 2023 18:00:00").getTime();
          ...
          <div className="timer-container d-flex flex-column p-5">
            ...
            <div className="d-flex flex-column">
              <div className="d-flex flex-row timer-row timer-row-1">
                ...
                <p className="timer-info timer-info-1 align-self-end">DAYS</p>
              </div>

              <div className="d-flex flex-row timer-row timer-row-2">
                <p className="timer-number timer-number-2">{timerHours}</p>
                <p className="timer-info timer-info-2 align-self-end">HOURS</p>
              </div>
